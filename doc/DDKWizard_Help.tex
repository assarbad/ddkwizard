...
\newcommand{\ddkwizver}[0]{\ddkwiz{} v1.3.1}
...
WDKs\footnote{Tested up to and including the 7600.16385.0 WDK.}.
...
\begin{enumerate}
  \item
    Download \texttt{DDKBUILD.BAT} from \extlinktt{http://ddkwizard.assarbad.net}{ddkwizard.assarbad.net}
    or \extlink{http://www.osronline.com/article.cfm?article=43}{this page}.
  \item
